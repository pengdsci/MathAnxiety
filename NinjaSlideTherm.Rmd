---
title: '<img src="img/titlenew04.png" width = 1400 height = 600> <BR><BR><BR><BR>.'
...
include_graphics("img/AnxietyEpidemic01.png")
```
...
```{r  echo=FALSE, fig.align='center', out.width = '1400px'}
include_graphics("img/MathAnxietyEcosystem.png")
```
...
include_graphics("img/SamplingMethodsAnalysis.png")
```
...
### <font color = "orange">Classical Approaches</font>
...
### <font color = "Orange">Our Novel Approach: Double Weighted Average</font>
<br>
<center>
<table style="width:80%">
        <tr>
            ...
            <font color = "Orange"><b>Step 2</b></font>: &nbsp;Performing PCA (linear or nonlinear)<BR><br>
            <font color = "Orange"><b>Step 3</b></font>: &nbsp;Adjusting PCA sign for positive correlation with total scores<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(call this <font color = "orange"><b>directional PCA </font></b>)<br><br>
            <font color = "Orange"><b>Step 4</b></font>: &nbsp;Taking weighted PCA average using variance proportions<BR>
            </td>
        </tr>
</table>
</center>   
...
datatable(indat,
          options = list(
            ...
            initComplete = JS(
              ...
              "  'font-size': '8px'  /* Font size for the entire pagination container */",
              "});",
              
              "$('.paginate_button').css({",
              "  'color': 'gold !important',",
              "  'background-color': '#4a2c5a !important',",
              "  'border': '1px solid #6b3f8c !important',",
              "  'border-radius': '1px !important',",
              "  'margin': '0 0px !important',",
              "  'padding': '0px 0px !important',  /* Increased padding for larger boxes */",
              "  'font-size': '8px !important',    /* Font size for Previous/Next and page numbers */",
              "  'min-width': '8px !important'     /* Minimum width for consistent box sizes */",
              "});",
              ...
              "  'border': '1px solid #8a5cb8 !important',",
...
```{r  echo=FALSE, fig.align='center', out.width = '900px'}
include_graphics("img/SixInsightsSummary.png")
```
...
# <font size = 12 color = "gold"><b>Acknowledgments</b></font>

<br>

We would like to thank **Dr. Emily Miller** for reviewing the report and providing insightful comments and suggestions that will support the next stages of manuscript preparation.

<br>

We also thank our graduate students **Christina Thompson-Acquah** and **Chloe Winters** for their assistance in setting up the survey instruments in Qualtrics and processing the data, respectively.
...
<table>
<tr>
<td> <img src = "img/blue-QR.png" alt="Thank You!" width="160" height="160"><br><font color = "gold" size = 3>Slides</font> </td>
<td><img src = "img/1.gif" alt="Thank You!" width="200" height="200"><br>&nbsp; </td>
<td><img src = "img/Report-QR.png" alt="Thank You!" width="160" height="160"><br><font color = "gold" size = 3> Report</font></td>
</tr>
</table>


Slides created using the following R packages through RStudio.
...
[**Silde Deck:** https://pengdsci.github.io/MathAnxiety/NinjaSlideTherm.html](https://pengdsci.github.io/MathAnxiety/NinjaSlideTherm.html)<br>
[**Report:**  https://pengdsci.github.io/MathAnxiety/index4presentation.html](https://pengdsci.github.io/MathAnxiety/index4presentation.html)
