...
<table>
        <tr>
            ...
            <li>Math Anxiety Epidemic and Anatomy of Math Anxiety</li>
            <li>Study Design, Instruments, and Analyses</li>
              <ul>
                <li>Sampling and demographics</li>
                <li>Instruments and Information Aggregation</li>
              </ul>
            <li>Graphical Analysis of Math Anxiety </li>
            <li>Association between Anxiety and Relevant Factors </li>
            <li>Modeling Math Anxiety Ecosystem</li>
            <li>Potential Interventions </li>
...
# <font color = "gold"><b>Graphical Exploration: <br> Student Perceived Teaching Stragies</b></font>
...
## <font color = "gold"><b>Modeling the Anxiety Ecosystem<br> A Struactural Equation Modeling Approach</b></font>
...
Slides created via the R packages through R Studio
